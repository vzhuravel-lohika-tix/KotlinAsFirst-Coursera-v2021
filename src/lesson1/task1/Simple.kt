 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = 0.63256
 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double = 5.0
 ...
 */
fun thirdDigit(number: Int): Int = 8
 ...
 */
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int = 216
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = 133.1
 ...
 */
fun numberRevert(number: Int): Int = 874
